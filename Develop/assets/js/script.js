...
const mainDir = path.join(__dirname, "/public") //path.join basically joins two paths together. __dirname is whatever directory the script is being executed in, and /public is a public directory
